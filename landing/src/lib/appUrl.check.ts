...
import { APP_START_PATH, appStartHref, appHref, paymentReturnCallbackUrl } from './appUrl'
...
console.assert(
  paymentReturnCallbackUrl('in').endsWith('/api/payment-return?country=IN'),
  paymentReturnCallbackUrl('in')
)
