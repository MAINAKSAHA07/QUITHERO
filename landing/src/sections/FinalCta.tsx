...
<section className="final-cta">
    ...
    <div className="container" style={{position: 'relative', zIndex: '2'}}>
      ...
      <a href={appStartHref()} className="pulse-btn reveal js-start-app">Start Smono Now</a>
      <a href="mailto:support@smono.app" className="btn-ghost reveal nav-coach" style={{display: 'inline-flex', marginTop: '16px', marginLeft: '12px'}}>Talk to a Quit Coach</a>
