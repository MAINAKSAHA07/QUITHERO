...
export const COUNTRIES: Record<string, CountryConfig> = {
  IN: { name: 'India', currency: 'INR', symbol: '₹', pricePerCigarette: 8, nicotinePerCigarette: 0.8 },
  US: { name: 'United States', currency: 'USD', symbol: '$', pricePerCigarette: 0.55, nicotinePerCigarette: 0.8 },
  GB: { name: 'United Kingdom', currency: 'GBP', symbol: '£', pricePerCigarette: 0.65, nicotinePerCigarette: 0.8 },
  CA: { name: 'Canada', currency: 'CAD', symbol: 'C$', pricePerCigarette: 0.70, nicotinePerCigarette: 0.8 },
  AU: { name: 'Australia', currency: 'AUD', symbol: 'A$', pricePerCigarette: 1.50, nicotinePerCigarette: 0.8 },
  DE: { name: 'Germany', currency: 'EUR', symbol: '€', pricePerCigarette: 0.40, nicotinePerCigarette: 0.8 },
  FR: { name: 'France', currency: 'EUR', symbol: '€', pricePerCigarette: 0.55, nicotinePerCigarette: 0.8 },
  ...
  ZA: { name: 'South Africa', currency: 'ZAR', symbol: 'R', pricePerCigarette: 3.5, nicotinePerCigarette: 0.8 },
  AE: { name: 'UAE', currency: 'AED', symbol: 'د.إ', pricePerCigarette: 1.0, nicotinePerCigarette: 0.8 },
  SA: { name: 'Saudi Arabia', currency: 'SAR', symbol: '﷼', pricePerCigarette: 1.0, nicotinePerCigarette: 0.8 },
  ...
  PH: { name: 'Philippines', currency: 'PHP', symbol: '₱', pricePerCigarette: 7.5, nicotinePerCigarette: 0.8 },
  ...
  MX: { name: 'Mexico', currency: 'MXN', symbol: 'MX$', pricePerCigarette: 4.5, nicotinePerCigarette: 0.8 },
  ...
  ES: { name: 'Spain', currency: 'EUR', symbol: '€', pricePerCigarette: 0.30, nicotinePerCigarette: 0.8 },
  NL: { name: 'Netherlands', currency: 'EUR', symbol: '€', pricePerCigarette: 0.45, nicotinePerCigarette: 0.8 },
  SE: { name: 'Sweden', currency: 'SEK', symbol: 'kr', pricePerCigarette: 3.5, nicotinePerCigarette: 0.8 },
  NZ: { name: 'New Zealand', currency: 'NZD', symbol: 'NZ$', pricePerCigarette: 1.60, nicotinePerCigarette: 0.8 },
