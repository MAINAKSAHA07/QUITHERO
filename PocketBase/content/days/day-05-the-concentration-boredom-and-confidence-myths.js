...
export const steps = [
  {
    order: 1,
    type: 'text',
    module_key: 'day05_intro',
    step_title: "One drug cannot relax you and stimulate you, cure boredom and sharpen focus.",
    slug: 'day-05-the-concentration-boredom-and-confidence-myths-intro',
    content_role: 'intro',
    content_json: {
      "title": "One drug cannot relax you and stimulate you, cure boredom and sharpen focus.",
      "text": "One drug cannot relax you and stimulate you, cure boredom and sharpen focus. It does none of them.\n\nYou've dismantled \"I enjoy it\" and \"it relaxes me.\" Today we clear the remaining excuses in one pass: it helps me concentrate, it relieves boredom, it gives me confidence. These feel like separate, sensible reasons. They're the same illusion in different clothes.\n\nCBT focus today: Cognitive restructuring — exposing the last \"crutch\" beliefs as a single illusion wearing four different costumes."
    },
  },
  {
    order: 2,
  ...
  },
  {
    order: 8,
    type: 'question_open',
    module_key: 'day05_reflection',
    step_title: "Reflection",
    slug: 'day-05-the-concentration-boredom-and-confidence-myths-reflection',
    content_role: 'reflection',
    content_json: {
      "question": "• Which of the four \"costumes\" has fooled you the longest?\n\n• When you picture a calm, focused, confident non-smoker, what do they have that you assumed only a cigarette could give?\n\n• Complete: \"The cigarette never gave me confidence/focus/calm. What it actually did was...\"",
  ...
  },
  {
    order: 9,
    type: 'text',
    module_key: 'day05_preview',
    step_title: "Tomorrow",
    slug: 'day-05-the-concentration-boredom-and-confidence-myths-preview',
    content_role: 'preview',
    content_json: {
      "title": "Tomorrow",
      "text": "If smoking does nothing for you, why does it feel so true that it does? We trace the beliefs back to their source — the lifelong brainwashing that installed them."
    },
  },
]
