...
const configs = [
  ...
  { name: 'coach_sessions', list: adminOrOwner('user'), view: adminOrOwner('user'), create: adminOrOwner('user'), update: adminOrOwner('user'), delete: adminRule },
  { name: 'coach_messages', list: adminOrOwner('user'), view: adminOrOwner('user'), create: adminOrOwner('user'), update: adminRule, delete: adminRule },
  { name: 'user_segments', list: adminRule, view: adminRule, create: adminRule, update: adminRule, delete: adminRule },
  ...
  { name: 'account_deletion_requests', list: adminOrOwner('user'), view: adminOrOwner('user'), create: '@request.auth.collectionName = "admin_users" || (@request.auth.id != "" && @request.body.user = @request.auth.id)', update: adminRule, delete: adminRule },
